...
<center><div style="width:55%">
  <img src="{{site.img_url}}/img/assets/img/posts/carpaccio_burak.jpg" alt="Carpaccio z buraka" height="200px" width="40px" />
  <font size="2">
...
<center><div style="width:45%">
  <img src="{{site.img_url}}/img/assets/img/posts/galabki_szara_em.jpg" alt="Gołąbki z kasztanami" height="200px" width="40px" />
...
koło której umieszczone zostały kuleczki jagodowe (jagodowy kawior). Kuleczki były zachwycające.
 ...
 <center><div style="width:55%">
  <img src="{{site.img_url}}/img/assets/img/posts/gruszka_w_winie.jpg" alt="Gruszki z parfait cynamonowym" height="200px" width="40px" />
